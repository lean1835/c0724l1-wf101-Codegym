...
import { addNewService } from "../services/FuramaService";
...
function AddComponent() {
        const [serviceAdd,setServiceAdd]=useState({id:"",name:"",acreage:'',cost:'',maxPeople:'',rentalType:'',img:'',type:{
                id:'',name:''
    ...
    // id:"",name:"",acreage:'',cost:'',maxPeople:'',rentalType:'',type:{
    //     id:'',name:'',img:''
    // },standard:'',amenities:'',acreagePool:'',floors:'',free:''
    ...
    return (
        <>
            <h1>--Thêm dịch vụ--</h1>
            <Formik initialValues={serviceAdd} onSubmit={handleSubmit} validationSchema={handleValidate} >
                <Form>
                    <div>
                        <label >Name:</label>
